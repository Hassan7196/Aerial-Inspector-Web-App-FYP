...
@section('content')
    ...
    <h1 style="color:#800080;font-weight: bold">Orders: <span style="color: green">Delievered</span></h1>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="dropdown show" style="float:right;padding-right: 3em">
                    <a class="btn btn-success dropdown-toggle btn-success fa fa-angle-down" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        Delivered
                    </a>

                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">

                        <a class="dropdown-item" href="{{url('/updateStatus/'.$customer->OsId.'/pending')}}">Pending</a>
