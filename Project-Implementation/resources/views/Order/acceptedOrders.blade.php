...
@section('content')
    ...
    <h1 style="color:#800080;font-weight: bold">Orders: <span style="color: blue">Accepted</span></h1>
        ...
        <div class="card-header">
          <h2 style="color:black;"> {{$customer->firstName." ".$customer->lastName}}</h2>
            <div class="dropdown show" style="float:right;padding-right: 3em">
                <a class="btn btn-primary dropdown-toggle btn-success fa fa-angle-down" href="#" role="button" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    Accepted
                </a>
